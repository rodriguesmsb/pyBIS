...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        if platform.system().lower() == 'linux':
            self.comboBox.addItems(['SIM', 'SINAN', 'SINASC'])
        #   self.db = []
        #   try:
        #       for i in os.listdir(
        ...
        #       os.mkdir(os.path.expanduser('~/Documentos/files_db/'))
            ...
            for i in os.listdir(
                    os.path.expanduser('~\\Documentos/files_db\\')):
                for x in os.listdir(
                        os.path.expanduser('~\\Documentos\\files_db\\' + i
                                           + '\\')):
        ...
        self.horizontalSlider.setMaximum(2018)
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.label_5)
        ...
        self.list_data.setGeometry(350, 40, 800, 550)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setCurrentText(_translate("MainWindow", "SELECT SYSTEM"))
        self.comboBox.setItemText(-1, _translate("MainWindow", "SELECT SYSTEM"))
        self.label_3.setText(_translate("MainWindow", "SELECT DATA TIME"))
